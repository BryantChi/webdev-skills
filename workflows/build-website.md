...
**必須執行：** 讀取並執行 `skills/webdev/logic/reasoning.md`
...
- 讀取對應的 `skills/webdev/code/*.md` 設定 linting
- 建立 `.editorconfig`
- 建立 `README.md`
...
**必須執行：** 讀取 `skills/webdev/logic/design-system-gen.md`
